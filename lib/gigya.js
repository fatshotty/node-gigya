...
var Gigya = function Gigya(apiKey, secret, useHttps, apiDomain, doHttpRequest) {
  ...
  self.useHttps = useHttps === false ? false : true;
  ...
  var apiCall = function(endpoint, params, callback, retries, emitter) {
    ...
    if(self.doHttpRequest) {
      self.doHttpRequest({ baseUrl: baseUrl, params: params }, function(err, response) {
        if(err) {
          handleError(err);
        } else {
      ...
      curl.setopt('POST', '1');
      curl.setopt('POSTFIELDS', queryParams);
      ...
      request({ url: baseUrl, form: params, method: 'POST' }, function(err, response, body) {
        if(err) {
          handleError(err);
          return;
        }
  ...
  self.ids = {};
  self.ids.deleteAccount = function(params, callback) {
    return apiCall('ids.deleteAccount', params, callback);
  }
  self.ids.getAccountInfo = function(params, callback) {
    return apiCall('ids.getAccountInfo', params, callback);
  }
  self.ids.getCounters = function(params, callback) {
    return apiCall('ids.getCounters', params, callback);
  }
  self.ids.getRegisteredCounters = function(params, callback) {
    return apiCall('ids.getRegisteredCounters', params, callback);
  }
  self.ids.getSchema = function(params, callback) {
    return apiCall('ids.getSchema', params, callback);
  }
  self.ids.incrementCounters = function(params, callback) {
    return apiCall('ids.incrementCounters', params, callback);
  }
  self.ids.registerCounters = function(params, callback) {
    return apiCall('ids.registerCounters', params, callback);
  }
  self.ids.setAccountInfo = function(params, callback) {
    return apiCall('ids.setAccountInfo', params, callback);
  }
  self.ids.setSchema = function(params, callback) {
    return apiCall('ids.setSchema', params, callback);
  }
  self.ids.unregisterCounters = function(params, callback) {
    return apiCall('ids.unregisterCounters', params, callback);
  }
  self.ids.search = function(params, callback) {
    return queryApiCall('ids.search', params, callback);
  }
